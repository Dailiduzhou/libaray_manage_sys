...
- [x] T1. 创建 Repository 接口定义 (BookRepository, UserRepository, BorrowRepository)
...
- [x] T4. 检查 models/models.go 是否有需要调整
...
- [x] T8. 创建 repositories/repositories.go 统一导出
...
- [x] T12. 创建 services/services.go 统一导出
...
- [x] T13. 修改 BookHandler 依赖注入
- [x] T14. 修改 UserHandler 依赖注入
- [x] T15. 修改 BorrowHandler 依赖注入
- [x] T16. 重构 controllers/controller.go 整体结构
- [x] T17. 更新 main.go 依赖注入 Wiring
...
- [x] T16. 重构 controllers/controller.go 整体结构
- [x] T17. 更新 main.go 依赖注入 Wiring
- [x] T18. 创建 Handler 单元测试示例
- [x] T19. 创建 Repository 集成测试示例
- [x] T20. 运行 go generate 验证 mock 生成
- [x] T21. 运行 go build 验证编译
- [x] T22. 运行 go test 验证测试通过
